...
```
OpenCode DOES use the `provider/model` slash form on the CLI (unlike Rutilea,
...
`hermes-custom-providers` skill, pitfall 2). Rutilea hits this because it forwards
