...
version: 1.0.0
author: Yeongyu Kim (code-yeongyu), adapted by Rutilea Agent
license: MIT
...
- This complements (does not replace) Rutilea's `patch` tool: `patch` is for targeted edits you author; ast-grep is for pattern-driven bulk rewrites across many sites.
