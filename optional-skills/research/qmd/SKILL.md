...
metadata:
  hermes:
    ...
    related_skills: [obsidian, rutilea-agent, arxiv]
---
...
Rutilea Agent via the native MCP client. This is the preferred
...
Then configure Rutilea Agent to connect via HTTP:
