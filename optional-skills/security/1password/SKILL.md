...
version: 1.0.0
author: arceus77-7, enhanced by Rutilea Agent
license: MIT
...
- `tmux` available for stable authenticated sessions during Rutilea terminal calls (desktop app flow only)
...
### Service Account (recommended for Rutilea)
...
## Rutilea Execution Pattern (desktop app flow)

Rutilea terminal commands are non-interactive by default and can lose auth context between calls.
