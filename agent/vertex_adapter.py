"""Vertex AI (Google Cloud) adapter for Rutilea Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Rutilea to use Gemini models via Google Cloud with
...
# who installed plain `rutilea-agent` and only later selected a Gemini model.
try:
