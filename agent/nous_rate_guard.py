...
(3 SDK retries x 3 Rutilea retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_rutilea_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".rutilea")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Rutilea, ...) behind one endpoint.  A 429 can mean either:
