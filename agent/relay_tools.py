"""Core NeMo Relay adapter for Rutilea tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Rutilea tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Rutilea Relay tool execution cannot run on an active event-loop thread"
    )
