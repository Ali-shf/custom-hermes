...
# ``data:`` field before Rutilea receives a completion chunk.  Keeping this
...
# case: a stream dies mid-response and Rutilea persists a content-less
...
def classify_api_error(
    ...
    *,
    ...
    # rutilea_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from rutilea_cli.plugins import get_plugin_error_classification
