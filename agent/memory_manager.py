...
class MemoryManager:
    ...
    def add_provider(self, provider: MemoryProvider) -> None:
        ...
        from toolsets import _RUTILEA_CORE_TOOLS

        _core_tool_names = set(_RUTILEA_CORE_TOOLS)
    ...
    def _strip_skill_scaffolding(text: str) -> Optional[str]:
        ...
        When a user invokes a /skill or /bundle, Rutilea expands the turn into
    ...
    def _prefetch_provider(
        ...
        # Propagate the caller's contextvars (profile RUTILEA_HOME override)
    ...
    def _submit_background(self, fn, *, kind: str = "write") -> None:
        ...
        dashboard, cron) is a ContextVar-scoped RUTILEA_HOME override, and
    ...
    def initialize_all(self, session_id: str, **kwargs) -> None:
        ...
        Automatically injects ``rutilea_home`` into *kwargs* so that every
        provider can resolve profile-scoped storage paths without importing
        ``get_rutilea_home()`` themselves.
        """
        if "rutilea_home" not in kwargs:
            from rutilea_constants import get_rutilea_home
            kwargs["rutilea_home"] = str(get_rutilea_home())
        for provider in self._providers:
            try:
