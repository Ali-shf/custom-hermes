"""
Skills configuration for Rutilea Agent.
`rutilea skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.rutilea/config.yaml under:
...
from rutilea_cli.config import cfg_get, load_config, save_config
from rutilea_cli.colors import Colors, color
from rutilea_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `rutilea skills`."""
    from rutilea_cli.curses_ui import curses_checklist
