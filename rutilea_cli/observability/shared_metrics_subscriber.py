"""Relay subscriber for the persisted Rutilea shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Rutilea counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Rutilea shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
