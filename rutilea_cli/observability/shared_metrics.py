"""Durable aggregation and local export for Rutilea shared metrics."""
...
from rutilea_cli.sqlite_util import write_txn
...
_PACKAGE_SCHEMA_VERSION = "rutilea.shared_metrics.v2"
...
class SharedMetricsStore:
    ...
    def __init__(
        ...
        root = get_rutilea_home() / "telemetry" / "shared_metrics"
        ...
        return [
            {
                ...
                "resource": {
                    "rutilea_version": row["rutilea_version"],
    ...
    def _ensure_schema(self) -> None:
        with self._connection(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            # Serialize first-run creation and upgrades across Rutilea processes.
            with write_txn(connection):
    ...
    def _create_package_in_transaction(
        ...
        resource = {
            "rutilea_version": period_row["rutilea_version"],
