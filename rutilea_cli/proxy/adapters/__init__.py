...
from rutilea_cli.proxy.adapters.base import UpstreamAdapter
from rutilea_cli.proxy.adapters.nous_portal import NousPortalAdapter
from rutilea_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``rutilea proxy start --provider <name>`` CLI flag.
