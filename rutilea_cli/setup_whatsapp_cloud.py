...
Entry point: ``rutilea whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``rutilea_cli/main.py``).
...
Rutilea gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Rutilea to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Rutilea needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Rutilea gateway in another terminal:")
    print("         rutilea gateway")
    print()
