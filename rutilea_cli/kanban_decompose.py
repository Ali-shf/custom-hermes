...
Invoked by ``rutilea kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Rutilea Agent board.
...
def _profile_author() -> str:
    """Mirror of ``rutilea_cli.kanban._profile_author``."""
    return (
