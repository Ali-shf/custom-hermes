"""Client for uploading ``rutilea debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``rutilea debug share``.
...
NAS_BASE = os.environ.get(
    "RUTILEA_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "rutilea-agent/debug-share"
