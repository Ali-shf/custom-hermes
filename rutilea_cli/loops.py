...
Design notes / invariants (same contract as ``rutilea_cli/goals.py``):
...
- This module has zero hard dependency on ``cli.RutileaCLI``, the gateway
...
def _get_session_db() -> Optional[Any]:
    """One SessionDB per RUTILEA_HOME (same pattern as goals._get_session_db)."""
    try:
