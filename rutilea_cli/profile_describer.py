...
Used by ``rutilea profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``rutilea_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Rutilea Agent kanban board.
...
Rules:
  ...
  - Never write "Rutilea Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_rutilea_home())
        else:
