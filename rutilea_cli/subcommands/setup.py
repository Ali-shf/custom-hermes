"""``rutilea setup`` subcommand parser.
...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure Rutilea Agent with an interactive wizard. "
        "Run a specific section: "
        "rutilea setup model|tts|terminal|gateway|tools|telemetry|agent",
    )
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare 'rutilea setup' now does this.",
    )
    setup_parser.add_argument(
        "--quick",
        action="store_true",
