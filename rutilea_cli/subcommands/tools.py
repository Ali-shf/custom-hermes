"""``rutilea tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'rutilea tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # rutilea tools list [--platform cli]
    ...
    # rutilea tools disable <name...> [--platform cli]
    ...
    # rutilea tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `rutilea tools` runs after you pick a provider that\n"
