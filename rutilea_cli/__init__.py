"""
Rutilea CLI - Unified command-line interface for Rutilea Agent.

Provides subcommands for:
- rutilea chat          - Interactive chat (same as ./rutilea)
- rutilea gateway       - Run gateway in foreground
- rutilea gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `rutilea setup` on a fresh Pi.
    ...
    rutilea_cli/stdio.py::configure_windows_stdio() runs later from the entry
