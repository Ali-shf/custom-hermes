...
Visual styling mirrors the Rutilea Research design system (the
...
``tests/rutilea_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Rutilea Agent</title>
<style>
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Rutilea Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Rutilea Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
