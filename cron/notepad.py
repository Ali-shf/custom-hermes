...
Write path is the CLI (``rutilea cron notepad <job_id> set <key> <value>``),
...
NOTEPAD_FILE = get_rutilea_home().resolve() / "cron" / "notepad.db"
...
def render_notepad_section(job_id: str) -> str:
    ...
    return (
        ...
        f"`rutilea cron notepad {job_id} set <key> <value>` "
        f"(also: get/delete/list; `rutilea cron notepad {job_id} delete "
