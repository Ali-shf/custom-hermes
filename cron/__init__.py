"""
Cron job scheduling system for Rutilea Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    rutilea gateway install    # Install as a user service
    sudo rutilea gateway install --system  # Linux servers: boot-time system service
    rutilea gateway            # Or run in foreground
