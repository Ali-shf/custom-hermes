...
version: 1.0.1
author: Rutilea Agent (adapted from gsd-build/get-shit-done)
license: MIT
...
**Verify variants visually — use Rutilea' browser tools.** Don't just write HTML and hope it renders; load each variant and look at it:
