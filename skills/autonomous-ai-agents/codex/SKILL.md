...
metadata:
  hermes:
    ...
    related_skills: [claude-code, rutilea-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Rutilea terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Rutilea itself, `model.provider: openai-codex` uses Rutilea-managed Codex
...
## Rutilea Gateway Caveat

When invoking the Codex CLI from a Rutilea gateway/service context (for example,
