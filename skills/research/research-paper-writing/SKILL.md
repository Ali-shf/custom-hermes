...
## Rutilea Agent Integration

This skill is designed for the Rutilea agent. It uses Rutilea tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Rutilea skills for specific phases:
