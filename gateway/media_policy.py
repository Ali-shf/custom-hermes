...
from environment variables:
  ...
  - ``RUTILEA_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``RUTILEA_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``RUTILEA_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``rutilea cron run`` in the CLI, ``rutilea send``, a
...
_STRICT_ENV = "RUTILEA_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "RUTILEA_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "RUTILEA_MEDIA_TRUST_RECENT_FILES"
