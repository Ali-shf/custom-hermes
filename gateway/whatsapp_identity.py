...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$RUTILEA_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_rutilea_dir("platforms/whatsapp/session", "whatsapp/session")
