#!/usr/bin/env python3
"""
SWE Runner with Rutilea Trajectory Format

A runner that uses Rutilea-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Rutilea-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Rutilea-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Rutilea format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Rutilea-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Rutilea-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Rutilea Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Rutilea-Agent's built-in execution environments
    and outputs trajectories in Rutilea-Agent format.
    """
    ...
    def _convert_to_rutilea_format(
        self,
        ...
        """
        Convert internal message format to Rutilea trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Rutilea trajectory format
        trajectory = self._convert_to_rutilea_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Rutilea trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Rutilea Trajectory Format")
    print("=" * 60)
