...
Config: ~/.rutilea/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.rutilea/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_rutilea_home()`` helper (RUTILEA_HOME-aware and
...
RULES_FILE = get_rutilea_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_rutilea_home() / "feishu_comment_pairing.json"
