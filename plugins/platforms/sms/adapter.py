...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Rutilea gateway adapter.

    Each inbound phone number gets its own Rutilea session (multi-tenant).
...
# static dict in rutilea_cli/gateway.py, and the _send_sms dispatch in
