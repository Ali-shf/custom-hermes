...
required — uses aiohttp which is already a Rutilea dependency.
...
def interactive_setup() -> None:
    ...
    ``rutilea_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Rutilea delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # rutilea_cli/setup.py::_setup_mattermost function.
