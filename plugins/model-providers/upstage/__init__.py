...
# When the user hasn't picked a reasoning effort, Rutilea passes
...
# ON at this effort — matching the "medium (default)" that Rutilea' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Rutilea' effort vocabulary onto Solar's accepted set. xhigh/max/
