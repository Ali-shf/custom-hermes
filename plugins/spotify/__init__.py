...
``_check_spotify_available()`` — when the user has not run ``rutilea auth
spotify``, the tools remain registered (so they appear in ``rutilea
...
The Spotify auth flow (``rutilea auth spotify``), CLI plumbing, and docs
