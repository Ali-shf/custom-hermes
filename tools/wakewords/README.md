...
`hey_rutilea.onnx` / `hey_rutilea.tflite` — the on-device "Hey Rutilea" hotword
...
- **Label:** the model registers as `hey_rutilea` (matches the filename).
