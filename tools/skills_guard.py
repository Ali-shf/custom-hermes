...
Trust levels:
  - builtin:   Ships with Rutilea. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.rutilea/\.env|\~/\.rutilea/\.env',
     "rutilea_env_access", "critical", "exfiltration",
     "directly references Rutilea secrets file"),
    ...
    (r'\.rutilea/config\.yaml|\.rutilea/SOUL\.md',
     "rutilea_config_mod", "critical", "persistence",
     "references Rutilea configuration files directly"),
...
# scan. `.skillignore` is the Rutilea-native name; `.clawhubignore` is honored
