/**
 * Canonical Rutilea skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$RUTILEA_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`rutilea_cli/skin_engine.py`),
 ...
 *   • CLI     → `rutilea_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
