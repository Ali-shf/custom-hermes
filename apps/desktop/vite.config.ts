...
export default defineConfig(({ command }) => ({
  ...
  resolve: {
    alias: {
      ...
      '@rutilea/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@rutilea/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@rutilea/shared': path.resolve(__dirname, '../shared/src'),
      react: reactDir,
