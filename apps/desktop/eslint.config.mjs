...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @rutilea/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@rutilea/shared'],
              message: 'Plugins import only @rutilea/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
