...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/rutilea-agent')).toBe('~/www/rutilea-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/rutilea-agent')).toBe('rutilea-agent')
    expect(pathLeaf('~/www/rutilea-agent')).toBe('rutilea-agent')
