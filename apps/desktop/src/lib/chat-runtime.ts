...
import type { ModelOptionsResponse, SessionInfo } from '@/types/rutilea'
 ...
 *
 * Only the leading status prefix (e.g. "Rutilea is thinking...") and the
 ...
 *  resolved comment as JSON (RutileaPrComment shape); a malformed payload falls
