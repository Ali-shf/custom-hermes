...
import { type BillingBlock, skillInvocationText } from '@rutilea/shared'
...
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/rutilea'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @rutilea/shared BillingBlock).
