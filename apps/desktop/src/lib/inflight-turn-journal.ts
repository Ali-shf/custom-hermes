...
const LEGACY_STORAGE_KEY = 'rutilea.desktop.inflightTurnJournal.v1'
const STORAGE_PREFIX = 'rutilea.desktop.inflightTurnJournal.v2:'
const LEGACY_MIGRATION_KEY = 'rutilea.desktop.inflightTurnJournal.v2.migrated'
