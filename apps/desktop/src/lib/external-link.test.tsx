...
function installDesktopBridge(partial: Partial<Window['rutileaDesktop']> = {}) {
...
function installTitleBridge(title: string) {
  ...
  installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['rutileaDesktop']['fetchLinkTitle'] })
...
afterEach(() => {
  ...
  if (initialRutileaDesktop) {
    ...
    delete desktopWindow.rutileaDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['rutileaDesktop']['openExternal'] })
