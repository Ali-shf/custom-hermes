 ...
 * plugins resolve `@rutilea/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __RUTILEA_PLUGIN_SDK__: sdk,
  __RUTILEA_REACT__: React,
  __RUTILEA_REACT_JSX__: jsxRuntime,
  __RUTILEA_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@rutilea/plugin-sdk': shimUrl('__RUTILEA_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__RUTILEA_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__RUTILEA_REACT_JSX__'),
    react: shimUrl('__RUTILEA_REACT__')
  }
