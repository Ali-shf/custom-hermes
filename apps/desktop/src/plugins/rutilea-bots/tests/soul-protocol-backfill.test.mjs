...
test('generated protocol uses rutilea profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `rutilea profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `rutilea profiles list` for the LIVE/)
})
