...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshRutileaPathTitle: string
      sshRutileaPathDesc: string
      sshRutileaPathPlaceholder: string
  ...
  commandCenter: {
    ...
    rutileaActiveSessions: (version: string, count: number) => string
