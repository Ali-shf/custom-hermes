...
export const en: Translations = {
  ...
  boot: {
    ready: 'Rutilea Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Rutilea settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Rutilea backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingRutileaDesktop: 'Starting Rutilea Desktop…'
    },
    errors: {
      backgroundExited: 'Rutilea background process exited.',
      backgroundExitedDuringStartup: 'Rutilea background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Rutilea backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateRutilea: 'Update Rutilea',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Rutilea Desktop.',
    ...
    native: {
      ...
      inputBody: 'Rutilea is waiting for your response.',
      turnDoneTitle: 'Rutilea finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Rutilea defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Rutilea backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Rutilea backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Rutilea is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Rutilea asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Rutilea was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Rutilea was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Rutilea follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Rutilea can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Rutilea is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Rutilea, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Rutilea Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Rutilea runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Rutilea checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Rutilea configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Rutilea.',
    ...
    connections: {
      title: 'Connections',
      intro:
        'Register every place your agents live — this device, remote gateways on your network, and Rutilea Cloud instances. All of them are stored here.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Rutilea Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Rutilea Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Rutilea runtime managed by this app.',
      kindRemoteDesc: 'A Rutilea gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Rutilea Cloud account.',
      kindSshDesc: 'A Rutilea install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Rutilea manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Rutilea Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Rutilea backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset RUTILEA_DESKTOP_REMOTE_URL and RUTILEA_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Rutilea backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Rutilea backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Rutilea Cloud',
      cloudDesc: 'Sign in once to Rutilea Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Rutilea Cloud',
      cloudSignIn: 'Sign in to Rutilea Cloud',
      cloudSignedIn: 'Signed in to Rutilea Cloud',
      cloudNeedsSignIn: 'Sign in to Rutilea Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Rutilea Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Rutilea Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Rutilea Cloud',
      cloudSignedOutMessage: 'Cleared the Rutilea Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /rutilea.',
      ...
      restartingMessage: 'Rutilea Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Rutilea ${version}` : ''}`,
      ...
      sshDesc:
        'Rutilea is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshRutileaPathTitle: 'Rutilea path (optional)',
      sshRutileaPathDesc: 'Full path to the remote rutilea binary. Blank = auto-detect.',
      sshRutileaPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Rutilea found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Rutilea runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Rutilea is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Rutilea path.',
      sshErrPlatform:
        'Unsupported remote platform. Rutilea Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Rutilea on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Rutilea. Review the exact configuration below — it comes from the link, not from Rutilea.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Rutilea runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Rutilea at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with a Nous subscription — sign in to Rutilea Portal to activate.',
      nousAuthNeededTitle: 'Sign in to Rutilea Portal',
      nousAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to Rutilea Portal.`,
      nousAuthSignIn: 'Sign in',
      nousAuthDoneTitle: 'Rutilea Portal connected',
      nousAuthDoneMessage: 'Your subscription backends are now active.',
      nousAuthFailed: 'Rutilea Portal sign-in did not complete',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via rutilea curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Rutilea builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Rutilea to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Rutilea to generate pets.',
      backgroundHint: 'You can close this — Rutilea will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Rutilea desktop' },
    ...
    rutileaActiveSessions: (version, count) => `Rutilea ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@rutilea:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Rutilea environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Rutilea did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Rutilea will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Rutilea backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Rutilea. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Rutilea backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Rutilea...',
    placeholderReconnecting: 'Reconnecting to Rutilea…',
    ...
    attachUrlDesc: 'Rutilea will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Rutilea to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Rutilea…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Rutilea…',
    ...
    unsupportedMessage: 'This version of Rutilea can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Rutilea from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Rutilea will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Rutilea desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Rutilea updater takes over in its own window and reopens Rutilea automatically when it’s done. Please don’t reopen Rutilea yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Rutilea reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Rutilea reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Rutilea?',
    blockerBody:
      'Rutilea needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Rutilea',
    foreignBlockerBody:
      'Rutilea can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Rutilea can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Rutilea needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Rutilea Desktop',
    setupChoiceDesc:
      'Connect this app to a Rutilea gateway you already run, or install Rutilea locally on this computer.',
    connectExistingTitle: 'Connect to existing Rutilea',
    ...
    installLocalTitle: 'Install Rutilea locally',
    installLocalDesc: 'Download Rutilea, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Rutilea Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Rutilea',
    remoteSetupDesc: 'Enter your gateway URL. Rutilea Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Rutilea gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/rutilea',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Rutilea gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Rutilea Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Rutilea CLI or desktop instance is running. Stop any running Rutilea instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Rutilea installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Rutilea Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Rutilea is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Rutilea…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Rutilea',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Rutilea at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Rutilea connects automatically',
    ...
    authorizeThere: 'Authorize Rutilea there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Rutilea there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Rutilea Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Rutilea Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Rutilea will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Rutilea is restarting...',
      askRestart: 'Ask Rutilea to restart the server',
      lookingRestart: taskId => `Rutilea is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Rutilea is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Rutilea finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Rutilea could not restart the server.',
      stillWorking:
        'Rutilea is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Rutilea is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Rutilea gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.rutilea/config.yaml). Rutilea won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Rutilea needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Rutilea needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Rutilea Desktop to use Save Image.',
    restartToSaveImages: 'Restart Rutilea Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `rutilea gateway` running?'
    }
  },
