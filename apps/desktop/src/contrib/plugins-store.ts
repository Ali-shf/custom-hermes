 ...
 * `<rutilea home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'rutilea.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'rutilea.desktop.disabledPlugins.v1'
