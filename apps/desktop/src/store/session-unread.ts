...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('rutilea.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('rutilea.desktop.unreadFinishedSessions')
