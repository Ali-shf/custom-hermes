...
const POPOUT_STORAGE_KEY = 'rutilea.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'rutilea.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'rutilea.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'rutilea.desktop.composerPopout.position'
