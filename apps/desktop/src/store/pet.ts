...
export interface PetInfo {
  ...
  // the Rutilea "run" activity state uses the in-place running row).
 ...
 * RUTILEA_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'rutilea.desktop.pet-roam.v1'
