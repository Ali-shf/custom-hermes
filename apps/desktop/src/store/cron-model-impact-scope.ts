...
function identityForConnection(connection: RutileaConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: RutileaConnection | null): void {
