/**
 * Rutilea skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$RUTILEA_HOME/skins/` (or a
 * built-in) resolved by `rutilea_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Rutilea authors from a prompt lights up all three surfaces from one file.
 *
...
import type { RutileaSkin, SkinColors } from '@rutilea/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: RutileaSkin): DesktopTheme | null {
