...
// (#73044). Exercises the REAL rutilea + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/rutilea')
...
const conn = (over: Partial<RutileaConnection> = {}): RutileaConnection =>
  ({
    authMode: 'oauth',
