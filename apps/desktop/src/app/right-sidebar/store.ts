...
const TAKEOVER_KEY = 'rutilea.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Rutilea can't clear via the API — the user
 *  sees exactly what runs instead of Rutilea silently deleting their creds. */
