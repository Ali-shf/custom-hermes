import type { RutileaReviewFile } from '@/global'
...
export function buildReviewFlatList(files: RutileaReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: RutileaReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
