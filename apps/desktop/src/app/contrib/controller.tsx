...
registry.registerMany([
  ...
  // The agent's write -> see loop: rescan <rutilea home>/desktop-plugins
  ...
  // The keybind panel's non-titlebar door (the keyboard icon is gone).
  {
    ...
    data: {
      ...
      run: () => window.dispatchEvent(new CustomEvent('rutilea:open-keybinds'))
    } satisfies PaletteContribution
  },
      ...
      <ContribWiring>
        <ShellContextMenu>
          <div
            ...
            // [data-rutilea-glass] rules in styles.css clear them so the tint
