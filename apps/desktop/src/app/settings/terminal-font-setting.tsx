...
import { setRutileaConfigCache, useRutileaConfigRecord } from '../hooks/use-config-record'
...
function fontFamilyFromConfig(config: RutileaConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useRutileaConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<RutileaConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setRutileaConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="rutilea-terminal-font-families"
          ...
          <datalist id="rutilea-terminal-font-families">
