...
import { saveMemoryProviderConfig } from '@/rutilea'
import { notify, notifyError } from '@/store/notifications'
import { $activeGatewayProfile } from '@/store/profile'
import type { MemoryProviderConfig, MemoryProviderField } from '@/types/rutilea'
          ...
          {config.docs_url && (
            <a
              ...
              onClick={event => {
                ...
                void window.rutileaDesktop?.openExternal?.(config.docs_url)
              }}
              rel="noreferrer"
              target="_blank"
            >
