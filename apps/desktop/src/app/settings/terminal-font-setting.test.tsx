...
vi.mock('@/rutilea', () => ({
  saveRutileaConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setRutileaConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useRutileaConfigRecord: () => ({ data: mocks.loadedConfig })
}))
