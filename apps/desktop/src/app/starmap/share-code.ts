...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/rutilea'
...
const VERSION = 3
const PREFIX = 'HML' // "Rutilea Memory Loadout" — namespaces our codes like WoW's leading bytes.
