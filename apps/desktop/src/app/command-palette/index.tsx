...
import { getRutileaConfigRecord, listAllProfileSessions } from '@/rutilea'
...
// Rutilea session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
  ...
  const configQuery = useQuery({
    ...
    queryFn: () => getRutileaConfigRecord()
  })
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-rutilea',
            keywords: ['update', 'upgrade', 'rutilea', 'version', 'system', 'restart'],
            label: cc.updateRutilea,
