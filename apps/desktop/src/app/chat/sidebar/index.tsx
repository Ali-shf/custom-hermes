...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/rutilea'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('rutilea:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('rutilea:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Rutilea to
