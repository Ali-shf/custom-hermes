...
import type { RutileaGitBranch } from '@/global'
...
const branchActionLabel = (branch: RutileaGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<RutileaGitBranch[]>([])
  ...
  const convert = async (branch: RutileaGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
