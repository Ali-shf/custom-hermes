...
import { type DroppedFile, extractDroppedFiles, RUTILEA_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, RUTILEA_PATHS_MIME) ? 'files' : null
