...
const FOCUS_EVENT = 'rutilea:composer-focus'
const INSERT_EVENT = 'rutilea:composer-insert'
const ATTACH_IMAGES_EVENT = 'rutilea:composer-attach-images'
const INSERT_REFS_EVENT = 'rutilea:composer-insert-refs'
const SUBMIT_EVENT = 'rutilea:composer-submit'
const VOICE_TOGGLE_EVENT = 'rutilea:composer-voice-toggle'
const MODEL_MENU_EVENT = 'rutilea:composer-model-menu'
