...
import type { ModelOptionProvider, OAuthProvider } from '@/types/rutilea'
...
// onboarding / Providers key form lists every `api_key` provider `rutilea model`
...
const SHOW_ALL_KEY = 'rutilea-onboarding-show-all-v1'
