...
const STORAGE_KEY = 'rutilea.desktop.layoutTree.v2'

writeKey('rutilea.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('rutilea.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('rutilea.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'rutilea.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'rutilea.desktop.paneShare.v1'
...
writeKey('rutilea.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__RUTILEA_LAYOUT_TREE__ = {
    close: closeTreePane,
