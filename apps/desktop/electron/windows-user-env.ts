...
// even though a fresh shell — and the Rutilea CLI — sees it immediately. The
// desktop's RUTILEA_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\rutilea. Reading
...
//       RUTILEA_HOME    REG_SZ    F:\Rutilea\data
//
