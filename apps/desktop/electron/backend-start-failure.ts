 ...
 * startRutilea() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startRutilea() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startRutilea`, re-emits
