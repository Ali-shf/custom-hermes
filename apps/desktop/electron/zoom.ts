...
export const ZOOM_STORAGE_KEY = 'rutilea:desktop:zoomLevel'
 ...
 * but forgot to emit 'rutilea:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('rutilea:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
