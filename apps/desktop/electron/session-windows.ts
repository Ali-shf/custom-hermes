...
// by main.ts (`setBackgroundThrottling` driven by the merged `rutilea:active-work`
...
// (the "Rutilea idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Rutilea" wake word has NO preceding click,
