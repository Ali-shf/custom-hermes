...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    rutilea_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__rutilea_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-Rutilea-Session-Token":
              (window as unknown as { __RUTILEA_SESSION_TOKEN__?: string })
                .__RUTILEA_SESSION_TOKEN__ ?? "",
          },
        });
