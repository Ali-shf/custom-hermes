 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `rutilea_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Rutilea Teal",
  description: "Classic dark teal — the canonical Rutilea look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Rutilea Teal (Large)",
  description: "Rutilea Teal with bigger fonts and roomier spacing",
