...
const STORAGE_KEY = "rutilea-dashboard-theme";
...
const FONT_STORAGE_KEY = "rutilea-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `rutilea_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "rutilea-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-rutilea-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-rutilea-theme-font", "true");
