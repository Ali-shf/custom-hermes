 ...
 *
 * Plugins call window.__RUTILEA_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__RUTILEA_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__RUTILEA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__RUTILEA_PLUGIN_SDK__ = {
    ...
    // window.__RUTILEA_SESSION_TOKEN__ directly.
    authedFetch,
