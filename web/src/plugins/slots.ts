 ...
 * `window.__RUTILEA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Rutilea brand in the top bar
 ...
 *  `window.__RUTILEA_PLUGINS__.registerSlot(...)`.
 *
