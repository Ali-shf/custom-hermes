/**
 * Rutilea Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__RUTILEA_PLUGIN_SDK__`` and
 * ``window.__RUTILEA_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__RUTILEA_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``RutileaPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@rutilea/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__RUTILEA_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__RUTILEA_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__RUTILEA_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface RutileaPluginSDK {
...
declare global {
  interface Window {
    __RUTILEA_PLUGIN_SDK__?: RutileaPluginSDK;
    __RUTILEA_PLUGINS__?: PluginRegistry;
  }
}
