...
export interface Translations {
  ...
  status: {
    ...
    updateRutileaConfirmMessage?: string;
    updateRutileaConfirmNow?: string;
    updateRutileaConfirmTitle?: string;
    updatingRutilea: string;
  ...
  // ── Achievements plugin (plugins/rutilea-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
