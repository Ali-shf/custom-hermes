 ...
 *
 * Values mirror rutilea_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Rutilea default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Rutilea' default when unset). */
